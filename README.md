...
Vagueness Score의 전체 산식, 첫 턴의 35점 계산, 질문 정책 규칙은 [Interaction.md의 부록](./interaction.md#appendix--vagueness-score--policy-rule)을 참고하세요. 이 점수는 논문 공식을 그대로 재현한 값이 아니라, 상태 변화와 정책 결정을 설명하기 위한 local mock 휴리스틱입니다.
